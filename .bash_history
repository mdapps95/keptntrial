...
# -------------------------------------------#
helm install keptn https://github.com/keptn/keptn/releases/download/$KEPTN_VERSION/keptn-$KEPTN_VERSION.tgz -n keptn --create-namespace --set=apiGatewayNginx.type=LoadBalancer --set mongo.resources.requests.cpu=0 --set mongo.resources.requests.memory=0 --set nats.nats.resources.requests.cpu=0 --set nats.nats.resources.requests.memory=0 --set nats.nats.jetstream.memStorage.size=0M --set apiGatewayNginx.resources.requests.cpu=0 --set apiGatewayNginx.resources.requests.memory=0 --set remediationService.resources.requests.cpu=0 --set remediationService.resources.requests.memory=0 --set apiService.resources.requests.cpu=0 --set apiService.resources.requests.memory=0 --set bridge.versionCheck.enabled=false --set bridge.resources.requests.cpu=0 --set bridge.resources.requests.memory=0 --set distributor.resources.requests.cpu=0 --set distributor.resources.requests.memory=0 --set shipyardController.resources.requests.cpu=0 --set shipyardController.resources.requests.memory=0 --set secretService.resources.requests.cpu=0 --set secretService.resources.requests.memory=0 --set configurationService.resources.requests.cpu=0 --set configurationService.resources.requests.memory=0 --set resourceService.resources.requests.cpu=0 --set resourceService.resources.requests.memory=0 --set mongodbDatastore.resources.requests.cpu=0 --set mongodbDatastore.resources.requests.memory=0 --set lighthouseService.resources.requests.cpu=0 --set lighthouseService.resources.requests.memory=0 --set statisticsService.enabled=false --set approvalService.resources.requests.cpu=0 --set approvalService.resources.requests.memory=0 --set webhookService.resources.requests.cpu=0 --set webhookService.resources.requests.memory=0
# -----------------------------------------#
#    Step 4/9: Installing Prometheus      #
# -----------------------------------------#
helm repo add prometheus-community https://prometheus-community.github.io/helm-charts
helm install prometheus prometheus-community/prometheus --namespace monitoring --create-namespace --version ${PROMETHEUS_VERSION}
# --------------------------------------------#
...
helm install --namespace $JOB_EXECUTOR_NAMESPACE --create-namespace --set=remoteControlPlane.api.hostname=api-gateway-nginx.keptn --set=remoteControlPlane.api.token=$KEPTN_API_TOKEN --set=remoteControlPlane.topicSubscription="sh.keptn.event.deployment.triggered\,sh.keptn.event.test.triggered\,sh.keptn.event.action.triggered" job-executor-service https://github.com/keptn-contrib/job-executor-service/releases/download/$JOB_EXECUTOR_SERVICE_VERSION/job-executor-service-$JOB_EXECUTOR_SERVICE_VERSION.tgz
...
cd ..
ls
cat remediation_trigger.json
ls
cat remediation.yaml
cat shipyard.yaml
ls
cd ..
ls
cat quality_gated_release.sh
ls
cd quality_gated_release
ls
cd ..
cd prometheus
ls
